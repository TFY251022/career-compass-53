    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <div className="container py-8 space-y-16">
          ...
          {/* Section 1: Radar Chart with career type selector */}
          ...
          {/* Section 2: 推薦行動計畫 (moved ABOVE gap analysis) */}
          <section id="action-plan" className="scroll-mt-32">
            <ContentTransition isLoading={isLoading} skeleton={<ResourcesSkeleton />}>
          ...
          <section id="projects" className="scroll-mt-32">
            <ContentTransition isLoading={isLoading} skeleton={<ProjectsSkeleton />}>
